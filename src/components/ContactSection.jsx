...
export default function ContactSection() {
  return (
    ...
    >
      {/* Background Image (softer & cleaner) */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-20">
        ...
        <div className="mb-20 text-center">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white animate-fade-up [animation-delay:120ms]">
            Let’s build something meaningful
          </h2>

          <div className="w-32 h-[2px] bg-[#64FFDA]/80 mt-8 mx-auto animate-fade-up [animation-delay:240ms]" />

          <p className="mt-10 text-[#8892B0] text-lg max-w-2xl mx-auto animate-fade-up [animation-delay:360ms]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="animate-fade-up [animation-delay:520ms]">
            <form className="space-y-8 bg-[#112240]/60 backdrop-blur-sm p-10 rounded-2xl border border-white/10 shadow-2xl">
              ...
              <div>
                ...
                <input
                  ...
                  className="
                    ...
                    text-white
                    focus:border-[#64FFDA]
                    focus:ring-2 focus:ring-[#64FFDA]/20
              ...
              <button
                type="submit"
                className="
                  w-full mt-4 px-10 py-5 rounded-lg
                  bg-[#64FFDA] text-[#0A192F]
                  font-semibold text-lg
                  hover:-translate-y-1
                  hover:shadow-[0_0_35px_rgba(100,255,218,0.45)]
          ...
          {/* Socials */}
          <div className="space-y-12 animate-fade-up [animation-delay:680ms]">
